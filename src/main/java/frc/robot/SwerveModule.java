...
public class SwerveModule {
    ...
    private void setSpeed(SwerveModuleState desiredState, boolean isOpenLoop) {
        if (isOpenLoop) {
            ...
            double velocity = Conversions.MPSToFalcon(desiredState.speedMetersPerSecond,
                    Constants.Swerve.WHEEL_CIRCUMFRENCE, Constants.Swerve.DRIVE_GEAR_RATIO);
    ...
    public double getEncoderInMeters() {
        return Conversions.falconToMeters(driveMotor.getSelectedSensorPosition(), Constants.Swerve.WHEEL_CIRCUMFRENCE,
    ...
    public SwerveModuleState getState() {
        return new SwerveModuleState(
                ...
                Conversions.falconToMPS(driveMotor.getSelectedSensorVelocity(), Constants.Swerve.WHEEL_CIRCUMFRENCE,
                        Constants.Swerve.DRIVE_GEAR_RATIO),
                getAngle());
    }
}